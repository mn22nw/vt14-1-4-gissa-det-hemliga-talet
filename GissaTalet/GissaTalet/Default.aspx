    ...
    <div id="page">
        ...
        <div>
            ...
            <div id="placeholder">
                ...
                <asp:Label ID="Gissningar" runat="server" Text="" Visible="false" CssClass="gissningar1"></asp:Label>
                ...
                <asp:Label ID="PrevT" runat="server" Text="Du har redan gissat detta nummer" Visible="false"></asp:Label>
                ...
                <asp:Button ID="GuessAgain" runat="server" CssClass="igen" Text="Slumpa nytt hemligt tal." OnClick="Reload_Click" Visible="false" />
